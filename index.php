...
<div class="container">
    ...
    <div class="panel panel-default">
     ...
     <div class="row">
      ...
      <div class="col-lg-12"><button id="getmodal" data_table="<?= $MY_SESSION."_notscreen"   ?>"  data_type_id="1" data_title="ผู้ป่วย DM/HT ที่ยังไม่ได้รับการคัดกรอง CKD" class="btn btn-default btn-block btn-success" data-toggle="modal" data-target="#basicModal">ผู้ป่วย DM/HT ที่ยังไม่ได้รับการคัดกรอง CKD</button></div>
   ...
   <div class="modal-dialog">
     ...
     <div class="modal-content">
       <div class="modal-header">
         ...
         <h4 id="report_title" class="modal-title"></h4>

       </div><!-- modal-header-->
       <div class="modal-body">
         <div class="form-group">
     <label for="keyckd">Enter Key</label>
     <input type="password" class="form-control" id="keyckd" placeholder="Enter Key ">
   </div><!-- form-group-->
   <button id="submitkey" type="submit" class="btn btn-default">Submit</button>
   <br><br><br>
   <div id="result"  data_table=""    data_type_id=""></div><!-- result key-->
       </div><!-- modal-body-->
    ...
    <?php include('metformin.php'); ?><br>
    <button id="getmodal" data_table="<?= $MY_SESSION."_metformin_list"   ?>"  data_type_id="2"  data_title="สัดส่วนผู้ป่วย CKD Stage3-5 ที่ได้รับยา Metformin ในช่วง 3 เดือนที่ผ่านมา" class="btn btn-default btn-block btn-success" data-toggle="modal" data-target="#basicModal">สัดส่วนผู้ป่วย CKD Stage3-5 ที่ได้รับยา Metformin ในช่วง 3 เดือนที่ผ่านมา</button>
    </div>
    </div>
    <!--End Pie chart -->
    <!-- Pie chart aceiarb-->
    <div class="panel-body">
    <div class="thumbnail" style="width:100%; margin:auto;" >
    <?php include('aceiarb.php'); ?><br>
    <button id="getmodal" data_table="<?= $MY_SESSION."_aceiarb_list"   ?>" data_type_id="3" data_title="สัดส่วนผู้ป่วย CKD Stage3-5 ที่ได้รับยา ACEI/ARB ในช่วง 3 เดือนที่ผ่านมา" class="btn btn-default btn-block btn-success" data-toggle="modal" data-target="#basicModal">สัดส่วนผู้ป่วย CKD Stage3-5 ที่ได้รับยา ACEI/ARB ในช่วง 3 เดือนที่ผ่านมา</button>
    </div>
    </div>
    <!--End Pie chart -->


      <?php include('emr.php'); ?><br>
